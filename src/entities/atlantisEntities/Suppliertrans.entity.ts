...
@Index("UNI_3212", ["id"], { unique: true })
@Index("UNIX_1038", ["ftrid"], {})
@Index("UNIX_1039", ["perid", "trndate", "id"], {})
@Index("UNIX_1040", ["comid", "trndate", "id"], {})
@ObjectType()
@Entity("SUPPLIERTRANS", { schema: "dbo" })
export class Suppliertrans {
  ...
  @Field({ nullable: true })
  @ManyToOne(() => Fintrade, (fintrade) => fintrade.suppliertrans)
  ...
  @Field({ nullable: true })
  @ManyToOne(() => Supplier, (supplier) => supplier.suppliertrans)
  @JoinColumn([{ name: "PERID", referencedColumnName: "id" }])
  per: Supplier;

  @Field({ nullable: true })
  @ManyToOne(() => Suptrntype, (suptrntype) => suptrntype.suppliertrans)
  @JoinColumn([
