...
@Index("KEF_CUSTOMER_PK", ["recId"], { unique: true })
@ObjectType()
@Entity("KEF_CUSTOMER", { schema: "dbo" })
export class KefCustomer {
  ...
  @Column("int", { name: "PRCID", nullable: true })
  prcid: number | null;
  ...
  @Column("varchar", { name: "RESP_NAME", nullable: true, length: 50 })
